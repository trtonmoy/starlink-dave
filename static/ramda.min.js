!(function (t, n) {
  ...
  function c(t, r, e) {
    return function () {
      for (
        var u = [], i = 0, a = t, s = 0;
        r.length > s || arguments.length > i;

      ) {
        var f;
        s >= r.length || (n(r[s]) && arguments.length > i)
          ? ((f = arguments[i]), (i += 1))
          : (f = r[s]),
          (u[s] = f),
          n(f) || (a -= 1),
  ...
  (v.prototype["@@transducer/init"] = g.init),
    (v.prototype["@@transducer/result"] = function (t) {
      return (
    ...
    (v.prototype["@@transducer/step"] = function (t, n) {
      return (
        this.f(n) ||
          ((this.all = !1), (t = d(this.xf["@@transducer/step"](t, !1)))),
        t
      );
    });
  ...
  function N(t, n, r) {
    if (("function" == typeof t && (t = S(t)), A(r)))
    ...
    if ("function" == typeof r["fantasy-land/reduce"])
      return q(t, n, r, "fantasy-land/reduce");
  ...
  (W.prototype["@@transducer/init"] = g.init),
    (W.prototype["@@transducer/result"] = g.result),
    (W.prototype["@@transducer/step"] = function (t, n) {
  ...
  var T = Object.prototype.toString,
      ...
      "function" != typeof Object.keys || R
        ? function (t) {
            ...
            var n,
              ...
              e = [],
              u = R && C(t);
            for (n in t) !P(n, t) || (u && "length" === n) || (e[e.length] = n);
            if (B)
              for (r = F.length - 1; r >= 0; )
    ...
    z = e(
      y(["fantasy-land/map", "map"], I, function (t, n) {
  ...
  (X.prototype["@@transducer/init"] = g.init),
    ...
    (X.prototype["@@transducer/step"] = function (t, n) {
      return (
        this.f(n) &&
          ((this.any = !0), (t = d(this.xf["@@transducer/step"](t, !0)))),
        t
      );
    });
  ...
  (tt.prototype["@@transducer/init"] = g.init),
    (tt.prototype["@@transducer/result"] = function (t) {
  ...
  var ct = r(function t(n) {
      return (
        ...
        a(V(x, 0, K("length", it(n))), function () {
          var t = arguments;
  ...
  var At = function (t) {
    ...
    St = e(
      y(["fantasy-land/chain", "chain"], Ot, function (t, n) {
  ...
  function tn(t, n, r, e) {
    ...
    switch (i) {
      ...
      case "Object":
        if (
          ...
          "Promise" ===
            (null == (u = (t.constructor + "").match(/^function (\w*)/))
              ? ""
              : u[1])
        )
          return t === n;
      ...
      case "Number":
      case "String":
        if (typeof t != typeof n || !Gt(t.valueOf(), n.valueOf())) return !1;
        break;
      case "Date":
    ...
    switch (i) {
      case "Map":
        return (
          t.size === n.size &&
          Qt(t.entries(), n.entries(), r.concat([t]), e.concat([n]))
        );
      case "Set":
        return (
          t.size === n.size &&
          Qt(t.values(), n.values(), r.concat([t]), e.concat([n]))
        );
      case "Arguments":
      case "Array":
      case "Object":
  ...
  (ln.prototype["@@transducer/init"] = g.init),
    (ln.prototype["@@transducer/result"] = g.result),
  ...
  var gn = r(function (t) {
    ...
    vn = e(function (t, n) {
      ...
      if (null != t && gt(t["fantasy-land/concat"]))
    ...
    bn = e(function (t, n) {
      ...
      return 0 === t
        ...
        : xt(
            yt(t, function (t, r, e, u, i, o, c, a, s, f) {
              switch (arguments.length) {
                case 1:
                  return new n(t);
                case 2:
  ...
  (An.prototype["@@transducer/init"] = g.init),
    (An.prototype["@@transducer/result"] = function (t) {
      var n;
      ...
      case "function":
        return null !== r._nativeSet
          ? n
            ...
            : r._nativeSet.has(t)
          : u in r._items
          ? !!en(t, r._items[u]) || (n && r._items[u].push(t), !1)
          : (n && (r._items[u] = [t]), !1);
      case "undefined":
  ...
  var In = e(function (t, n) {
      for (
        var r = [], e = 0, u = t.length, i = n.length, o = new Nn(), c = 0;
        i > c;
        c += 1
      )
        o.add(n[c]);
      for (; u > e; ) o.add(t[e]) && (r[r.length] = t[e]), (e += 1);
      return r;
    }),
    Pn = f(function (t, n, r) {
  ...
  (Un.prototype["@@transducer/init"] = g.init),
    (Un.prototype["@@transducer/result"] = g.result),
    (Un.prototype["@@transducer/step"] = function (t, n) {
      return this.n > 0
        ? ((this.n -= 1), t)
  ...
  (Mn.prototype["@@transducer/init"] = g.init),
    (Mn.prototype["@@transducer/result"] = g.result),
  ...
  (Vn.prototype["@@transducer/init"] = g.init),
  ...
  (Jn.prototype["@@transducer/init"] = g.init),
    (Jn.prototype["@@transducer/result"] = function (t) {
  ...
  (Zn.prototype["@@transducer/init"] = g.init),
    (Zn.prototype["@@transducer/result"] = g.result),
  ...
  (rr.prototype["@@transducer/init"] = g.init),
    (rr.prototype["@@transducer/result"] = g.result),
  ...
  (hr.prototype["@@transducer/init"] = g.init),
    ...
    (hr.prototype["@@transducer/step"] = function (t, n) {
      return (
        this.f(n) &&
          ((this.found = !0), (t = d(this.xf["@@transducer/step"](t, n)))),
        t
      );
    });
  ...
  (gr.prototype["@@transducer/init"] = g.init),
    ...
    (gr.prototype["@@transducer/step"] = function (t, n) {
      return (
        ...
        this.f(n) &&
          ((this.found = !0),
          (t = d(this.xf["@@transducer/step"](t, this.idx)))),
        t
      );
    });
  ...
  (br.prototype["@@transducer/init"] = g.init),
    (br.prototype["@@transducer/result"] = function (t) {
  ...
  (jr.prototype["@@transducer/init"] = g.init),
    (jr.prototype["@@transducer/result"] = function (t) {
      return this.xf["@@transducer/result"](
  ...
  var Ar = e(function (t, n) {
    ...
    Mr = e(function (t, n) {
      return "function" != typeof n.indexOf || p(n)
        ? rn(n, t, 0)
        : n.indexOf(t);
    }),
    Lr = Bt(0, -1),
  ...
  var re = f(function (t, n, r) {
    ...
    ie = e(function (t, n) {
      return a(t + 1, function () {
        ...
        throw new TypeError(
          gn(r) + ' does not have a method named "' + n + '"'
        );
      });
    }),
    oe = e(function (t, n) {
  ...
  function Ze(t, n) {
    if (null == n || !gt(n.then))
      throw new TypeError(
        "`" + t + "` expected a Promise, received " + dn(n, [])
      );
  }
  const Ge = e(function (t, n) {
  ...
  var pu = e(function (t, n) {
    ...
    Bu = e(function (t, n) {
      ...
      for (var r = [], e = 0; n.length > e; ) r.push(Bt(e, (e += t), n));
      return r;
    }),
    Fu = e(function (t, n) {
  ...
  (Lu.prototype["@@transducer/init"] = g.init),
    (Lu.prototype["@@transducer/result"] = g.result),
    (Lu.prototype["@@transducer/step"] = function (t, n) {
  ...
  ($u.prototype["@@transducer/init"] = g.init),
    ($u.prototype["@@transducer/result"] = g.result),
    ($u.prototype["@@transducer/step"] = function (t, n) {
  ...
  var Zu = ie(0, "toLowerCase"),
    ...
    ui = "\t\n\v\f\r   ᠎             　\u2028\u2029\ufeff",
    ii =
      !("function" == typeof String.prototype.trim) || ui.trim()
        ? r(function (t) {
            var n = RegExp("^[" + ui + "][" + ui + "]*"),
              r = RegExp("[" + ui + "][" + ui + "]*$");
    ...
    wi = e(function (t, n) {
      for (var r in t) if (P(r, t) && !t[r](n[r])) return !1;
      return !0;
    }),
    ji = e(function (t, n) {
      return wi(z(nn, t), n);
  ...
  (t.F = function () {
    ...
    (t.subtract = Uu),
    (t.sum = Ee),
    (t.symmetricDifference = Du),
    (t.symmetricDifferenceWith = zu),
    (t.tail = Ft),
    (t.take = Kn),
    (t.takeLast = ar),
    (t.takeLastWhile = Mu),
