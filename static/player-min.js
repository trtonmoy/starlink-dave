  ...
  (function (e, t) {
    ...
    var Se = {
      ...
      createBadge: function (e) {
        ...
        return (
          t.appendChild(
            D("span", { class: this.config.classNames.menu.badge }, e)
          ),
          t
        );
      },
        ...
        return (
          s.toggle
            ? (r.appendChild(
              ...
              r.appendChild(
                Se.createIcon.call(this, s.icon, { class: "icon--not-pressed" })
              ),
              r.appendChild(
          ...
          de(this.config.controls).forEach(function (o) {
            ...
            if (
              ...
              if (
                ...
                p.appendChild(
                  s.call(t, "volume", j(f, { id: "plyr-volume-".concat(e.id) }))
                );
              }
            }
            if (
              ...
              var y = D("div", {
                ...
                v = D("div"),
                b = D("div", { id: "plyr-settings-".concat(e.id, "-home") }),
                k = D("div", { role: "menu" });
              b.appendChild(k),
                v.appendChild(b),
                ...
                t.config.settings.forEach(function (i) {
                  ...
                  var s = D("span", null, ve(i, t.config)),
                    r = D("span", { class: t.config.classNames.menu.value });
                  (r.innerHTML = e[i]),
                    s.appendChild(r),
                    a.appendChild(s),
                    k.appendChild(a);
                  ...
                  l.appendChild(
                    D("span", { "aria-hidden": !0 }, ve(i, t.config))
                  ),
                    l.appendChild(
                      D(
                        "span",
            ...
            if (
              ...
              !x.url(T) &&
                t.isEmbed &&
                j(w, { icon: "logo-".concat(t.provider), label: t.provider }),
                  ...
                  this.supported.api
                    ? ((this.eventListeners = []),
                      ...
                      x.element(this.elements.container) ||
                        ((this.elements.container = D("div", { tabindex: 0 })),
